...
$.each(dh_data, function(i, item) {
  ...
  $.each(item_data, function(j, val) {
    strHtml += '<div class="col-xs-4 mb-2"><a class="dhurl" href="https://hao.hrka.net/goto/'+base64encode(val['url'])+'" target="_blank" style="color: rgb(41, 56, 70);background-color: rgb(255, 255, 255);">'+ val['name'] +'</a></div>';
  });
  strHtml += '</div></div>';	
});
...
var thisSearchIcon = 'logo.jpg'/*tpa=https://hao.hrka.net/logo.jpg*/;
...
$(function(){
  ...
  var search = {
    data: [{
      name: '百度',
      img: 'images/logo.jpg'/*tpa=https://hao.hrka.net/images/logo.jpg*/,
      url: 'https://www.baidu.com/s?wd='
    }, {
      name: '谷歌',
      img: 'images/logo_2.jpg'/*tpa=https://hao.hrka.net/images/logo_2.jpg*/,
      url: 'https://www.google.com/search?q='
    }, {
      name: '必应',
      img: 'images/logo_3.jpg'/*tpa=https://hao.hrka.net/images/logo_3.jpg*/,
      url: 'https://cn.bing.com/search?q='
    }, {
      name: '秘迹',
      img: 'images/logo_4.jpg'/*tpa=https://hao.hrka.net/images/logo_4.jpg*/,
      url: 'https://mijisou.com/?q='
    }, {
      name: '优惠券',
      img: 'images/logo_15.jpg'/*tpa=https://hao.hrka.net/images/logo_15.jpg*/,
